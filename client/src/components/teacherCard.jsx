  ...
  return (
    <div className=" ">
      ...
      <div className="space-y-4">
        {teachers.slice((page - 1) * itemsPerPage, page * itemsPerPage).map((teacher) => (
          <div
            key={teacher._id}
          ...
          >
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-gray-800 truncate">{teacher.firstname} {' '} {teacher.lastname}</h3>
            </div>
